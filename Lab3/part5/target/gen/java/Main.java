...
public class Main extends ASTRAClass {
	public Main() {
		...
		addRule(new Rule(
			...
			Predicate.TRUE,
			new Block(
				"Main", new int[] {5,27,34,5},
				new Statement[] {
					new ModuleCall("system",
						"Main", new int[] {6,8,6,53},
					...
					new ModuleCall("system",
						...
						new Predicate("createAgent", new Term[] {
							Primitive.newPrimitive("player3"),
					...
					new ModuleCall("system",
						"Main", new int[] {9,8,9,47},
						new Predicate("createAgent", new Term[] {
							Primitive.newPrimitive("player4"),
							Primitive.newPrimitive("Better")
						}),
						new DefaultModuleCallAdaptor() {
							public boolean inline() {
